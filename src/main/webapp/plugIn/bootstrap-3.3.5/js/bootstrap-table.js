...
!function ($) {
	...
	BootstrapTable.LOCALES['zh-CN'] = BootstrapTable.LOCALES['zh'] = {
        ...
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('\u6BCF\u9875\u663E\u793A\uFF1A%s', pageNumber);
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('\u663E\u793A%s\u81F3%s\uFF0C\u5171%s\u6761\u3002', pageFrom, pageTo, totalRows);
        },
        formatDetailPagination: function (totalRows) {
            return sprintf('\u5171%s\u6761\u3002', totalRows);
        },
        formatSearch: function () {
            return '\u641C\u7D22';
        },
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        html.push(
            '<div style="display:none" class="pull-' + this.options.paginationDetailHAlign + ' pagination-detail">',
